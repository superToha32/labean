...
@section('content')
    <div class="text-gray-700 text-2xl font-semibold my-5">Создание запроса на продажу</div>
    <form action="" method="POST" class="flex flex-col">

        @csrf

        <label class="mb-2" for="category_id">Категория продаваемого товара:</label>
